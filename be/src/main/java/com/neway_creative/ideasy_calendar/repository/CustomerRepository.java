...
public interface CustomerRepository extends JpaRepository<Customer, Integer> {
    ...
    @Query("SELECT new com.neway_creative.ideasy_calendar.dto.response.CustomerViewAdminResponse(c.customerId, c.name, c.emailAddress, c.status, c.facebookUrl) FROM Customer c WHERE c.role = 'CUSTOMER'")
